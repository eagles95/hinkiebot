...
def getGame(teamID):
    ...
    url = "https://statsapi.web.nhl.com/api/v1/teams/"+teamID+"?expand=team.schedule.next"
    ...
    if(data["status"]["statusCode"] != "1"):
        ...
        url = "https://statsapi.web.nhl.com/api/v1/teams/"+teamID+"?expand=team.schedule.previous"
